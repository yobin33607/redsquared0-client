...
{
	if (std::find(this->AlreadySentEvidence.begin(), this->AlreadySentEvidence.end(), data) != this->AlreadySentEvidence.end())
	{
		return true; // already delivered this exact evidence payload
	}
