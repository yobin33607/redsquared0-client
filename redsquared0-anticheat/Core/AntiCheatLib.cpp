...
bool AntiCheat::Impl::DoPreInitializeChecks()
{
    if (Config->bRequireRunAsAdministrator)
    {
        ...
        {
            MessageBoxA(0, "Program must be running as administrator in order to proceed, or change `bRequireRunAsAdministrator` to false.", "RedSquared0-Anticheat", 0);
    ...
    if (Config->bEnforceSecureBoot)
    {
        ...
        {
            MessageBoxA(0, "Secure boot is not enabled, you cannot proceed. Please enable secure boot in your BIOS or change `bEnforceSecureBoot` to false.", "RedSquared0-Anticheat", 0);
    ...
    if (Config->bEnforceDSE)
    {
        ...
        {
            MessageBoxA(0, "Test signing was enabled, you cannot proceed. Please turn off test signing via `bcdedit.exe`, or change `bEnforceDSE` to false.", "RedSquared0-Anticheat", 0);
